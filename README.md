...
* **HTML5** - Structuring the multi-view calendar canvas layouts.
* **CSS3** - Responsive grid blocks, standard device variable sheets, and minimalist vector designs.
* **JavaScript (Vanilla)** - Client-side operational logic, FileReader JSON serialization, and dynamic chronological date tracking arrays.

<h6><sub>WellTrack.xyz is completely open-sourced & free to use</sub></h6>
